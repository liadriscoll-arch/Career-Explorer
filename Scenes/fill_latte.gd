...
func _on_pressed() -> void:
	if Global.drink_selected == "regular_coffee" or Global.drink_selected == "decaf_coffee":
		...
		workstation_info_label.text = "Lattes require milk and caffeinated espresso" + "\r" + "use your espresso machine and regular beans to make espresso" + "\r" + "add espresso and milk into the latte cups"
		return
	...
	elif Global.drink_selected == "milk" and Global.latte_cup_made == "none" and Global.coffee_milk >= 1:
